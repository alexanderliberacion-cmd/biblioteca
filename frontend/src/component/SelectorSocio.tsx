...
export function SelectorSocio({socios, idSocio, onChangeSocio}: SelectorSocioProps): JSX.Element {
    return (
        <select value={idSocio} onChange={onChangeSocio} className="w-full border-2  bg-linear-to-r  from-amber-300 to-orange-400 rounded-md transition-transform hover:scale-105">
