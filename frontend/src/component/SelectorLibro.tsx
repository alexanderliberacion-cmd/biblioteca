...
export function SelectorLibro({libros, isbn, onChangeLibros}: SelectorLibroProps): JSX.Element {
    return (
        <>
            <select value={isbn} onChange={onChangeLibros} className="w-full border-2 bg-linear-to-r from-amber-300 to-orange-400 rounded-md transition-transform hover:scale-105">
